<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cPreguntasCerradas.aspx.cs" Inherits="EncuestaB0._1._0.Consultas.cPreguntasCerradas1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="right_col" role="main">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Consulta de Preguntas cerradas</div>
                    ...
                    <ContentTemplate>
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="col-sm-3 col-xs-3">
                                <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control input-sm" runat="server">
                                    <asp:ListItem>PreguntaCerradaId</asp:ListItem>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 col-xs-7">
                                <asp:GridView ID="DatoGridView" runat="server" Style="margin-top: 7px; margin-bottom: 0px" Width="580px" CssClass="table table-bordered bs-table input-sm" AllowPaging="true" OnPageIndexChanging="DatoGridView_PageIndexChanging">
                                    <HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />
                                    <EditRowStyle BackColor="#ffffcc" />
                                    <EmptyDataRowStyle ForeColor="Red" CssClass="table table-bordered" />
                                    <Columns>
                                        <asp:HyperLinkField DataNavigateUrlFields="PreguntaCerradaId" DataNavigateUrlFormatString="~/Registros/rPreguntasCerradas.aspx?idBuscado={0}" Text="Editar" />
                                    </Columns>
