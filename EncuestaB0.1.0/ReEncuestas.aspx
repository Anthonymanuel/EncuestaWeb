<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReEncuestas.aspx.cs" Inherits="EncuestaB0._1._0.VistasReportes.ReEncuestas" %>
                ...
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <rsweb:ReportViewer ID="EncuestasReportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="100%" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
                            <LocalReport ReportPath="Reportes\Encuestas.rdlc">
                                <DataSources>
                                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="DataSet1" />
                                </DataSources>
                            </LocalReport>
                        </rsweb:ReportViewer>
                        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="EncuestasTableAdapters.EncuestasTableAdapter" UpdateMethod="Update">
                            <DeleteParameters>
