                        ...
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 col-xs-7">
                                    <asp:GridView ID="DatoGridView" runat="server" Style="margin-top: 7px; margin-bottom: 0px" Width="580px" CssClass="table table-bordered bs-table input-sm" AllowPaging="true" EnableSortingAndPagingCallbacks="True">
                                        <HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />
                                        <EditRowStyle BackColor="#ffffcc" />
                                        <EmptyDataRowStyle ForeColor="Red" CssClass="table table-bordered" />
                                        <Columns>
                                            <asp:HyperLinkField DataNavigateUrlFields="EncuestaId" DataNavigateUrlFormatString="~/rEncuesta.aspx?idBuscado={0}" Text="Editar" />
                                        </Columns>
